...
<!--This file was modified by hosiet to generate better manpage XHTML document.
     (C) 2015 hosiet <073plan@gmail.com>
-->
...
<xslo:output xmlns:xslo="http://www.w3.org/1999/XSL/Transform" method="xml" encoding="UTF-8" indent="yes"/>
...
<xsl:include href="../xhtml/hosiet-manpage.xsl"/>
...
<xsl:template match="*" mode="process.root">
  ...
  <html>
    ...
    <head>
      <xsl:call-template name="hosiet.manpage.header"/>
    ...
    <body id="manpage">
      ...
      <xsl:call-template name="hosiet.manpage.process2"/>
    </body>
  </html>
